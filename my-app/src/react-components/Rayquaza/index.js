...
import rayquaza from "../Store/rayquaza.gif";
...
class Pikachu extends React.Component{
    ...
    buyPokemon = async () => {
        ...
        const rayquaza = { pokename: "Rayquaza", 
                          pokeid: 10, 
                          HP: 30, 
                          MaxHP: 40, 
                          Satiety: 8, 
        ...
        rayquaza.pokeid = this.idGenerator()
        user.pokemon.push(rayquaza)
                ...
                <div className="productPageBody">
                    ...
                    <div className="inline-pictures" >
                        <div>
                            ...
                            <img className="div-picture" src={rayquaza}></img>
                        </div>
